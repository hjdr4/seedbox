#!/bin/bash
cd /root
git clone https://github.com/CouchPotato/CouchPotatoServer.git &>/dev/null && patch /root/CouchPotatoServer/couchpotato/core/downloaders/qbittorrent_.py < /couchpotato.patch
